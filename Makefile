...
GE_RS232_SOURCE_FILES=ge-rs232.c ge-system-node.c
...
SMCPD_SOURCE_PATH=../smcp/src/smcpd
SMCPD_SOURCE_FILES=main.c
SMCPD_OBJECT_FILES=${addprefix $(SMCP_SOURCE_PATH)/,${subst .c,.o,$(SMCP_SOURCE_FILES)}}
